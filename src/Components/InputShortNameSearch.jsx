...
const InputShortNameSearch = ({ getInputValue, reset }) => {

    const [value, setValue] = useState({ value: 0, label: 'Enter Short Name To Search' });
...
export default memo(InputShortNameSearch)