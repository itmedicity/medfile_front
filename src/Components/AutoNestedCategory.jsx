...
const AutoNestedCategory = ({ getInputValue, reset }) => {
    ...
    const [value, setValue] = useState({ value: 0, label: 'Select Nested Category' });
        ...
        <Box>
            {
                isLoading === true || error
                    ...
                    : <Autocomplete
                        ...
                        options={[{ value: 0, label: 'Select Nested Category' }, ...filteredData] || []}
                        ...
                        onChange={(event, newValue) => {
                            if (newValue === null) {
                                ...
                                setValue(newValue);
                                getInputValue({ target: { name: 'nestedCategory', value: newValue.value } });
                            }
                        }}
                        value={value}
...
export default memo(AutoNestedCategory)
