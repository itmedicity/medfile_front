...
const AutoSubTypeMaster = ({ getInputValue, reset }) => {
    ...
    const [value, setValue] = useState({ value: 0, label: "Select Sub Type" });
        ...
        <Box>
            {
                isLoading === true || error
                    ...
                    : <Autocomplete
                        ...
                        options={[{ value: 0, label: "Select Sub Type" }, ...data] || []}
                        ...
                        onChange={(event, newValue) => {
                            if (newValue === null) {
                                ...
                                setValue(newValue);
                                getInputValue({ target: { name: 'subType', value: newValue.value } });
                            }
                        }}
                        value={value}
...
export default memo(AutoSubTypeMaster)