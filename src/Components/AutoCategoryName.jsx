...
const AutoCategoryName = ({ getInputValue, reset }) => {
    ...
    const [value, setValue] = useState({ value: 0, label: 'Select Category' });
        ...
        <Box>
            {
                isLoading === true || error
                    ...
                    : <Autocomplete
                        ...
                        options={[{ value: 0, label: 'Select Category' }, ...data] || []}
                        ...
                        onChange={(event, newValue) => {
                            if (newValue === null) {
                                ...
                                setValue(newValue);
                                getInputValue({ target: { name: 'category', value: newValue.value } });
                            }
                        }}
                        value={value}
...
export default memo(AutoCategoryName)