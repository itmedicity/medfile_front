...
const UserManagement = lazy(() =>
  import("./Modules/Settings/UserMangement/UserCreation.jsx")
);
const DocTypeMaster = lazy(() =>
  import("./Modules/Settings/DocumentTypeMaster/DoctypeMaster.jsx")
);
const SubTypeMaster = lazy(() =>
  import("./Modules/Settings/SubTypeMaster/SubTypeMaster.jsx")
);
const DocCategory = lazy(() =>
  import("./Modules/Settings/DocumentCategory/DocCategoryMaster.jsx")
);
const DocSubCategory = lazy(() =>
  import("./Modules/Settings/DocumentSubCategory/DocumentSubCategory.jsx")
);
const DocGroup = lazy(() =>
  import("./Modules/Settings/DocumentGroup/DocumentGroup.jsx")
);
const InstituteTypeMaster = lazy(() =>
  import("./Modules/Settings/InstituteTypeMaster/InstituteTypeMaster.jsx")
);
const InstitutionMaster = lazy(() =>
  import("./Modules/Settings/InstitutionMaster/InstitutionMaster.jsx")
);
const CourseType = lazy(() =>
  import("./Modules/Settings/CourseType/CourseType.jsx")
);
const CourseMaster = lazy(() =>
  import("./Modules/Settings/CourseMaster/CourseMaster.jsx")
);
