          ...
          <Box className="">
            ...
            >
              ...
              <Box className="flex flex-1 border p-1 border-[#8EADCD] rounded-lg flex-col">
                ...
                <Box className="flex flex-1 flex-col rounded-xl border p-2 gap-1 shadow-md">
                  <Box className="flex w-full border h-auto p-1 rounded-md">
                    ...
                    />
                    <Box className="flex bg-green-200">
                      <Typography>Image Name.png</Typography>
                    </Box>
                  </Box>
                  <Box className="flex w-full bg-green-300 h-auto p-2 rounded-md">
                    <img
                      alt="upload image"
                      src={dummyImage}
                      width={60}
