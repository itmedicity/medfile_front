...
const Settings = () => {
    ...
    const menuName = [
        ...
        { menuSlno: 25, menuName: 'Document Nested Category', menuCodeName: 'DocumentNestedCategory' },
        ...
        { menuSlno: 9, menuName: 'Course Type', menuCodeName: 'CourseType' },
        { menuSlno: 10, menuName: 'Course Name Master', menuCodeName: 'CourseMaster' },
        { menuSlno: 11, menuName: 'Rack Master', menuCodeName: 'RackMaster' },
        { menuSlno: 12, menuName: 'Location Master', menuCodeName: 'LocationMaster' },
        { menuSlno: 13, menuName: 'Custodian Master', menuCodeName: 'CustodianMaster' },
        { menuSlno: 14, menuName: 'Custodian Department', menuCodeName: 'CustodianDepartment' },
        { menuSlno: 15, menuName: 'user Type Master', menuCodeName: 'UserTypeMaster' },
        { menuSlno: 16, menuName: 'Module Name Master', menuCodeName: 'ModuleNameMaster' },
        { menuSlno: 17, menuName: 'Module Group Master', menuCodeName: 'ModuleGroupMaster' },
        { menuSlno: 18, menuName: 'Menu Name Master', menuCodeName: 'MenuNameMaster' },
        { menuSlno: 19, menuName: 'User Group Rights', menuCodeName: 'UserGroupRights' },
    ]
