...
import { getDocNestedCatCreateAuditReports, getDocNestedCatEditAuditReports } from '../../../api/commonAPI';
import DefaultPageLayout from '../../../Components/DefaultPageLayout';
import { AuditformatDate, AuditNestedCategoryecolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
import DateRangeFilter from '../AuditCommonCodes/DateRangeFilter';

const DocNestedCategoryReport = () => {
    ...
    return (
        <DefaultPageLayout label="Document Nested Category Audit Report">
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: '#f4f6f8' }}>
                                {AuditNestedCategoryecolumnsByTab[selectedTab].map((col) => (
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={AuditNestedCategoryecolumnsByTab[selectedTab].length}
                                        align="center"
...
export default memo(DocNestedCategoryReport);
