...
import { AuditNestedCategoryecolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
    ...
    return (
        <DefaultPageLayout label="Document Nested Category Audit Report">
            <Box sx={{ mt: 0, p: 1, bgcolor: '#fff' }}>
                ...
                {/* Table */}
                <Box sx={{ height: 500 }}>
                    <VirtualTable data={filteredLogs} columns={AuditNestedCategoryecolumnsByTab[selectedTab]} />
                </Box>
            </Box>
        </DefaultPageLayout>
    );
