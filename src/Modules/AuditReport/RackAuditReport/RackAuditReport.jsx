...
import { getRackCreateAuditReports, getRackEditAuditReports } from '../../../api/commonAPI';
import DefaultPageLayout from '../../../Components/DefaultPageLayout';
import { AuditformatDate, RackAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
import DateRangeFilter from '../AuditCommonCodes/DateRangeFilter';

const RackAuditReport = () => {
    ...
    const { isLoading: isLoadingCreated, data: createdData } = useQuery({
        ...
        queryFn: getRackCreateAuditReports,
        // staleTime: Infinity,
    ...
    const { isLoading: isLoadingEdited, data: editedData } = useQuery({
        ...
        queryFn: getRackEditAuditReports,
        // staleTime: Infinity,
        refetchOnWindowFocus: false,
    });
    ...
    return (
        <DefaultPageLayout label="Rack Audit Report">
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: '#f4f6f8' }}>
                                {RackAuditReportcolumnsByTab[selectedTab].map((col) => (
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={RackAuditReportcolumnsByTab[selectedTab].length}
                                        align="center"
...
export default memo(RackAuditReport);
