...
import { AuditSubTypecolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
...
const DocSubTypeReport = () => {
    ...
    return (
        <DefaultPageLayout label="Document Sub Type Audit Report">
            <Box sx={{ mt: 0, p: 1, bgcolor: '#fff' }}>
                ...
                <VirtualTable
                    data={filteredLogs}
                    columns={AuditSubTypecolumnsByTab[selectedTab]}
                />
            </Box>
        </DefaultPageLayout>
    );
