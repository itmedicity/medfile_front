...
import { getCustDeptCreateAuditReports, getCustDeptEditAuditReports } from '../../../api/commonAPI';
import DefaultPageLayout from '../../../Components/DefaultPageLayout';
import { AuditformatDate, CustDeptAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
import DateRangeFilter from '../AuditCommonCodes/DateRangeFilter';

const CustodianAuditReport = () => {
    ...
    const { isLoading: isLoadingCreated, data: createdData } = useQuery({
        ...
        queryFn: getCustDeptCreateAuditReports,
        // staleTime: Infinity,
    ...
    const { isLoading: isLoadingEdited, data: editedData } = useQuery({
        ...
        queryFn: getCustDeptEditAuditReports,
        // staleTime: Infinity,
        refetchOnWindowFocus: false,
    });
    ...
    return (
        <DefaultPageLayout label="Custodian Department Audit Report">
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: '#f4f6f8' }}>
                                {CustDeptAuditReportcolumnsByTab[selectedTab].map((col) => (
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={CustDeptAuditReportcolumnsByTab[selectedTab].length}
                                        align="center"
...
export default memo(CustodianAuditReport);
