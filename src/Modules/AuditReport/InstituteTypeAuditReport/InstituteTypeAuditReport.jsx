...
import { getInstituteTypeCreateAuditReports, getInstituteTypeEditAuditReports } from '../../../api/commonAPI';
import DefaultPageLayout from '../../../Components/DefaultPageLayout';
import { AuditformatDate, InstituteTypeAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
import DateRangeFilter from '../AuditCommonCodes/DateRangeFilter';

const InstituteTypeAuditReport = () => {
    ...
    const { isLoading: isLoadingCreated, data: createdData } = useQuery({
        ...
        queryFn: getInstituteTypeCreateAuditReports,
        // staleTime: Infinity,
    ...
    const { isLoading: isLoadingEdited, data: editedData } = useQuery({
        ...
        queryFn: getInstituteTypeEditAuditReports,
        // staleTime: Infinity,
        refetchOnWindowFocus: false,
    });
    ...
    return (
        <DefaultPageLayout label="Institute Type Audit Report">
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: '#f4f6f8' }}>
                                {InstituteTypeAuditReportcolumnsByTab[selectedTab].map((col) => (
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={InstituteTypeAuditReportcolumnsByTab[selectedTab].length}
                                        align="center"
...
export default memo(InstituteTypeAuditReport);
