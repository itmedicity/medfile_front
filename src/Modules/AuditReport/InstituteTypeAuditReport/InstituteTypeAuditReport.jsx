...
import { InstituteTypeAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
    ...
    return (
        <DefaultPageLayout label="Institute Type Audit Report">
            <Box sx={{ mt: 0, p: 1, bgcolor: '#fff' }}>
                ...
                {/* Table */}
                <Box sx={{ height: 500 }}>
                    <VirtualTable data={filteredLogs} columns={InstituteTypeAuditReportcolumnsByTab[selectedTab]} />
                </Box>
            </Box>
        </DefaultPageLayout>
    );
