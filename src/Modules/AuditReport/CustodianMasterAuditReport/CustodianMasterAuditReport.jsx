...
import { getCustMasterCreateAuditReports, getCustMasterEditAuditReports } from '../../../api/commonAPI';
import DefaultPageLayout from '../../../Components/DefaultPageLayout';
import { AuditformatDate, CustMasterAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
import DateRangeFilter from '../AuditCommonCodes/DateRangeFilter';

const CustodianMasterAuditReport = () => {
    ...
    const { isLoading: isLoadingCreated, data: createdData } = useQuery({
        ...
        queryFn: getCustMasterCreateAuditReports,
        // staleTime: Infinity,
    ...
    const { isLoading: isLoadingEdited, data: editedData } = useQuery({
        ...
        queryFn: getCustMasterEditAuditReports,
        // staleTime: Infinity,
        refetchOnWindowFocus: false,
    });
    ...
    return (
        <DefaultPageLayout label="Custodian Master Audit Report">
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: '#f4f6f8' }}>
                                {CustMasterAuditReportcolumnsByTab[selectedTab].map((col) => (
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={CustMasterAuditReportcolumnsByTab[selectedTab].length}
                                        align="center"
...
export default memo(CustodianMasterAuditReport);
