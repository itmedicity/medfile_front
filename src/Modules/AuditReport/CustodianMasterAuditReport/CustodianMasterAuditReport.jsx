...
import { CustMasterAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
    ...
    return (
        <DefaultPageLayout label="Custodian Master Audit Report">
            <Box sx={{ mt: 0, p: 1, bgcolor: '#fff' }}>
                ...
                <VirtualTable
                    data={filteredLogs}
                    columns={CustMasterAuditReportcolumnsByTab[selectedTab]}
                />
            </Box>
        </DefaultPageLayout>
    );
