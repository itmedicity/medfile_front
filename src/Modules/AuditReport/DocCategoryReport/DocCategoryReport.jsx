...
import { AuditCategoryecolumnsByTab, AuditDocTypecolumnsByTab, AuditformatDate, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={AuditCategoryecolumnsByTab[selectedTab].length}
                                        align="center"
                                ...
                                filteredLogs.map((log, index) => (
                                    ...
                                    >
                                        {AuditCategoryecolumnsByTab[selectedTab].map((col) => {
