...
import { getDocTypeCreateAuditReports, getDocTypeEditAuditReports } from '../../../api/commonAPI';
import DefaultPageLayout from '../../../Components/DefaultPageLayout';
import { AuditDocTypecolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
...
const DocMasterAudit = () => {
    ...
    const { data: createdData } = useQuery({
        ...
        queryFn: getDocTypeCreateAuditReports,
        // staleTime: Infinity,
    ...
    const { data: editedData } = useQuery({
        ...
        queryFn: getDocTypeEditAuditReports,
        // staleTime: Infinity,
        refetchOnWindowFocus: false,
    });
    ...
    return (
        <DefaultPageLayout label="Document Type Master Audit Report">
            <Box sx={{ mt: 0, p: 1, bgcolor: '#fff' }}>
                ...
                <VirtualTable
                    data={filteredLogs}
                    columns={AuditDocTypecolumnsByTab[selectedTab]}
                />
            </Box>
        </DefaultPageLayout>
    );
