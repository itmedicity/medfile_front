...
import { AuditDocTypecolumnsByTab, AuditformatDate, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={AuditDocTypecolumnsByTab[selectedTab].length}
                                        align="center"
