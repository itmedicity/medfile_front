...
import { AuditformatDate, DocGroupAuditReportcolumnsByTab, searchIconStyle, searchInputStyle } from '../AuditCommonCodes/auditCommonStyle';
import DateRangeFilter from '../AuditCommonCodes/DateRangeFilter';
import { getDocGroupCreateAuditReports, getDocGroupEditAuditReports } from '../../../api/commonAPI';

const DocGroupAuditReport = () => {
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{ bgcolor: '#f4f6f8' }}>
                                {DocGroupAuditReportcolumnsByTab[selectedTab].map((col) => (
                        ...
                        <TableBody>
                            {(isLoadingCreated || isLoadingEdited) ? (
                                <TableRow>
                                    <TableCell
                                        colSpan={DocGroupAuditReportcolumnsByTab[selectedTab].length}
                                        align="center"
...
export default memo(DocGroupAuditReport);
